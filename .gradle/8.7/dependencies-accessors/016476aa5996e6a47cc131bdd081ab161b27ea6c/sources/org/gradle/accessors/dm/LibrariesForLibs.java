...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final PoseLibraryAccessors laccForPoseLibraryAccessors = new PoseLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>pose</b>
     */
    public PoseLibraryAccessors getPose() {
        return laccForPoseLibraryAccessors;
    }
    ...
    public static class CameraLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public CameraLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>camera</b> with <b>androidx.camera:camera-camera2</b> coordinates and
    ...
    public static class PoseLibraryAccessors extends SubDependencyFactory {
        private final PoseDetectionLibraryAccessors laccForPoseDetectionLibraryAccessors = new PoseDetectionLibraryAccessors(owner);

        public PoseLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>pose.detection</b>
         */
        public PoseDetectionLibraryAccessors getDetection() {
            return laccForPoseDetectionLibraryAccessors;
        }

    }

    public static class PoseDetectionLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public PoseDetectionLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>detection</b> with <b>com.google.mlkit:pose-detection</b> coordinates and
         * with version reference <b>pose.detection</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> asProvider() {
            return create("pose.detection");
        }

        /**
         * Dependency provider for <b>accurate</b> with <b>com.google.mlkit:pose-detection-accurate</b> coordinates and
         * with version reference <b>pose.detection</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getAccurate() {
            return create("pose.detection.accurate");
        }
    ...
    public static class TextLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>text.recognition</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getJapanese() {
            return create("text.japanese");
        }

        /**
         * Dependency provider for <b>latin</b> with <b>com.google.mlkit:text-recognition</b> coordinates and
         * with version reference <b>text.recognition</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getLatin() {
            return create("text.latin");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final PoseVersionAccessors vaccForPoseVersionAccessors = new PoseVersionAccessors(providers, config);
        ...
        /**
         * Version alias <b>camerax</b> with value <b>1.4.0-beta02</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Group of versions at <b>versions.code</b>
         */
        public CodeVersionAccessors getCode() {
            return vaccForCodeVersionAccessors;
        }

        /**
         * Group of versions at <b>versions.pose</b>
         */
        public PoseVersionAccessors getPose() {
            return vaccForPoseVersionAccessors;
        }

        /**
         * Group of versions at <b>versions.text</b>
         */
        public TextVersionAccessors getText() {
            return vaccForTextVersionAccessors;
        }
    ...
    public static class CodeVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>code.scanner</b> with value <b>18.3.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class PoseVersionAccessors extends VersionFactory  {

        public PoseVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>pose.detection</b> with value <b>18.0.0-beta4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getDetection() { return getVersion("pose.detection"); }
    ...
    public static class TextVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>text.recognition</b> with value <b>16.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getRecognition() { return getVersion("text.recognition"); }
